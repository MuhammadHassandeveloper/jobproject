    ...
    <main class="main-content-area clearfix">
        <div class="post-job-area pb-100 pt-100">
                        ...
                        <div class=" post-form form-bg">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form action="jobs_controller.php?action=add" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" id="jobname"
                                                    placeholder="Enter the name of  job " name="name">
                                                <?php
            ...
            ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" id="jobname"
                                                    placeholder="Enter the location of job " name="location">
                                                <?php
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="jobcat" class="form-control custom-select" name="job_type">
                                                    ...
                                                    foreach ($data as $row) {
                                                        ?>
                                                    <option value=" <?php  echo $row['jt_id']  ?>">
                                                        <?php  echo $row['jt_name']  ?></option>
                                                    <?php
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="jobexp" class="form-control custom-select"
                                                    ...
                                                    foreach ($data as $row) {
                                                        ?>
                                                    <option value=" <?php  echo $row['exp_id']  ?>">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="jobexp" class="form-control custom-select"
                                                    ...
                                                    foreach ($data as $row) {
                                                        ?>
                                                    <option value=" <?php  echo $row['q_id']  ?>">
                                                        <?php  echo $row['q_name']  ?></option>
                                                    <?php
                                                    } ?>
                                                </select>
                                            </div>
            ...
            ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" name="vaccancies" class="form-control"
                                                    id="sallary">
                                                <?php
            ...
            ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" class="form-control" id="joblocation"
                                                    name="exp_date">
                                                <?php
