                        ...
                        <div class="submit-form form-bg">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                     $s_id=$_GET['id'];
                                     $sql="SELECT * FROM resume WHERE r_id='$s_id'";
                            ...
                            
                             {
                                 ?>
                                        ...
                                        <form action="resume_controller.php?action=edit" method="POST" enctype="multipart/form-data">
                                            <div class="form-info">
                                            ...
                                            <button name="edit" type="submit" class="btn btn-md btn-success">Submit</button>
                                        </form>
                                        <?php } ?>
                                    </div>
                                </div>
