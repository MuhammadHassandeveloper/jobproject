                            ...
                            <div class="search-bar text-center">
                                <form action="#" class="">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <a class="btn btn-primary btn-lg bg-green" href="post_job.php">
                                                Post New Job
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 mx-auto">
                        <div class="job-list-wrapper">
                            ...
                            global $connection;
                            $sql="SELECT categories.cat_name,job_experiences.exp_name,job_types.jt_name,qualifications.q_name,employees.*,jobs.* FROM (((((jobs INNER JOIN categories ON jobs.job_category=categories.cat_id)INNER JOIN job_experiences ON jobs.job_experience=job_experiences.exp_id) INNER JOIN job_types ON jobs.job_type=job_types.jt_id)INNER JOIN qualifications ON jobs.job_qualification=qualifications.q_id)INNER JOIN employees ON jobs.e_id=employees.e_id) WHERE employees.e_id='$e_id'";
...
?>
                                        ...
                                        <div class="meta-info d-flex">
                                            ...
                                            <p><i class="fa fa-map-marker" aria-hidden="true"></i><a
                                                    href="#"><?php echo $row['job_location'] ?></a>
                                            </p>
                                    ...
                                    <div>
                                        <span class="mb-2"> <a class="btn btn-sm btn-success"
                                                href="edit_job.php?jid=<?php echo $row['job_id'] ?>">Edit job</a>
                                        </span>
                                        <span>
                                            <a class="btn btn-sm btn-danger mt-2"
                                                href="jobs_controller.php?action=delete&&jid=<?php echo $row['job_id']   ?>">Delete</a>
                                        </span>
